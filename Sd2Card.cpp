...
IEC1SET;  //enable INT1 if SD Card not selected on the SPI bus
}
#endif
}
//------------------------------------------------------------------------------
...
if(!fspi_state_saved)
{
IEC1CLR; //clear INT1 in order to avoid PIC selecting the WIFI chip while SD Card processing on SPI bus
spi_state = SPI2CON;
SPI2CONbits.ON = 0;
